...
test('post editor layout keeps the card-editable fields in Craft admin', () => {
  ...
  assert.match(chipField, /label:\s*['"]?Muted Khaki['"]?/);
  assert.match(chipField, /value:\s*gold/);
  assert.match(chipField, /label:\s*['"]?Muted Sand['"]?/);
  assert.match(chipField, /value:\s*sand/);
  assert.match(chipField, /label:\s*['"]?Muted Sage['"]?/);
  assert.match(chipField, /value:\s*sage/);
  assert.match(chipField, /label:\s*['"]?Muted Olive['"]?/);
  assert.match(chipField, /value:\s*olive/);
  assert.match(chipField, /label:\s*['"]?Muted Sky['"]?/);
  assert.match(chipField, /value:\s*sky/);
  assert.match(chipField, /label:\s*['"]?Muted Stone['"]?/);
  assert.match(chipField, /value:\s*stone/);
  assert.match(chipField, /label:\s*['"]?Muted Rose['"]?/);
  assert.match(chipField, /value:\s*rose/);
  assert.match(chipField, /label:\s*['"]?Muted Clay['"]?/);
  assert.match(chipField, /value:\s*clay/);
  assert.match(chipField, /label:\s*['"]?Muted Plum['"]?/);
  assert.match(chipField, /value:\s*plum/);
